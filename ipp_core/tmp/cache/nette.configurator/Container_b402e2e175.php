<?php
// source: phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.neon
// source: phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon
// source: /ipp-php/phpstan.neon
// source: array
...
class Container_b402e2e175 extends _PHPStan_11268e5ee\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.broker.methodsClassReflectionExtension' => ['093' => true, '097' => true],
		'phpstan.broker.propertiesClassReflectionExtension' => ['094' => true, '099' => true, '0230' => true],
		...
		'phpstan.dynamicFunctionThrowTypeExtension' => ['0183' => true, '0222' => true, '0224' => true],
		...
		'phpstan.dynamicMethodThrowTypeExtension' => ['0209' => true],
		'phpstan.typeSpecifier.methodTypeSpecifyingExtension' => ['0240' => true],
		'phpstan.rules.rule' => [
			'0309' => true,
			'0313' => true,
			'0314' => true,
	...
	protected $types = ['container' => '_PHPStan_11268e5ee\Nette\DI\Container'];
	protected $aliases = [];

	protected $wiring = [
		'_PHPStan_11268e5ee\Nette\DI\Container' => [['container']],
		'PHPStan\Rules\Rule' => [
			[
				'0117',
				'0118',
		...
		'PHPStan\Rules\Generics\MethodSignatureVarianceRule' => [['rules.107']],
		'PHPStan\Rules\Generics\TraitTemplateTypeRule' => [['rules.108']],
		'PHPStan\Rules\Generics\UsedTraitsRule' => [['rules.109']],
		'PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule' => [['rules.110']],
		'PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule' => [['rules.111']],
		'PHPStan\Rules\Operators\InvalidBinaryOperationRule' => [['rules.112']],
		'PHPStan\Rules\Operators\InvalidUnaryOperationRule' => [['rules.113']],
		...
		'PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule' => [['rules.124']],
		'PHPStan\Rules\Classes\RequireImplementsRule' => [['rules.125']],
		'PHPStan\Rules\Classes\RequireExtendsRule' => [['rules.126']],
		'PHPStan\Rules\PhpDoc\RequireImplementsDefinitionClassRule' => [['rules.127']],
		'PHPStan\Rules\PhpDoc\RequireExtendsDefinitionClassRule' => [['rules.128']],
		'PHPStan\Rules\PhpDoc\RequireExtendsDefinitionTraitRule' => [['rules.129']],
		'PHPStan\Rules\Arrays\ArrayDestructuringRule' => [['rules.130']],
		'PHPStan\Rules\Arrays\IterableInForeachRule' => [['rules.131']],
		'PHPStan\Rules\Arrays\OffsetAccessAssignmentRule' => [['rules.132']],
		'PHPStan\Rules\Arrays\OffsetAccessAssignOpRule' => [['rules.133']],
		'PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule' => [['rules.134']],
		'PHPStan\Rules\Arrays\UnpackIterableInArrayRule' => [['rules.135']],
		'PHPStan\Rules\Exceptions\ThrowExprTypeRule' => [['rules.136']],
		'PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule' => [['rules.137']],
		'PHPStan\Rules\Functions\ClosureReturnTypeRule' => [['rules.138']],
		'PHPStan\Rules\Functions\ReturnTypeRule' => [['rules.139']],
		'PHPStan\Rules\Generators\YieldTypeRule' => [['rules.140']],
		'PHPStan\Rules\Methods\ReturnTypeRule' => [['rules.141']],
		'PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule' => [['rules.142']],
		'PHPStan\Rules\Properties\ReadOnlyPropertyAssignRule' => [['rules.143']],
		'PHPStan\Rules\Properties\ReadOnlyPropertyAssignRefRule' => [['rules.144']],
		'PHPStan\Rules\Properties\TypesAssignedToPropertiesRule' => [['rules.145']],
		'PHPStan\Rules\Variables\ThrowTypeRule' => [['rules.146']],
		'PHPStan\Rules\Variables\VariableCloningRule' => [['rules.147']],
		'PHPStan\Rules\Arrays\DeadForeachRule' => [['rules.148']],
		'PHPStan\Rules\DeadCode\UnreachableStatementRule' => [['rules.149']],
		'PHPStan\Rules\DeadCode\UnusedPrivateConstantRule' => [['rules.150']],
		'PHPStan\Rules\DeadCode\UnusedPrivateMethodRule' => [['rules.151']],
		'PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule' => [['rules.152']],
		'PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule' => [['rules.153']],
		'PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule' => [['rules.154']],
		...
		'PHPStan\Rules\Functions\ImplodeFunctionRule' => [['rules.162']],
		'PHPStan\Rules\Constants\MissingClassConstantTypehintRule' => [['rules.163']],
		'PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule' => [['rules.164']],
		'PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule' => [['rules.165']],
		'PHPStan\Rules\Methods\MissingMethodParameterTypehintRule' => [['rules.166']],
		...
		'PHPStan\Reflection\MethodsClassReflectionExtension' => [['081', '091', '093', '095', '097']],
		'PHPStan\Reflection\Annotations\AnnotationsMethodsClassReflectionExtension' => [['081']],
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [['082', '092', '094', '095', '099', '0230']],
		...
		'PHPStan\Rules\ClassCaseSensitivityCheck' => [['0112']],
		'PHPStan\Rules\Classes\LocalTypeAliasesCheck' => [['0113']],
		'PHPStan\Rules\Comparison\ConstantConditionRuleHelper' => [['0114']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeHelper' => [['0115']],
		'PHPStan\Rules\Exceptions\ExceptionTypeResolver' => [1 => ['0116'], [1 => 'exceptionTypeResolver']],
		'PHPStan\Rules\Exceptions\DefaultExceptionTypeResolver' => [['0116']],
		'PHPStan\Rules\Exceptions\MissingCheckedExceptionInFunctionThrowsRule' => [['0117']],
		'PHPStan\Rules\Exceptions\MissingCheckedExceptionInMethodThrowsRule' => [['0118']],
		'PHPStan\Rules\Exceptions\MissingCheckedExceptionInThrowsCheck' => [['0119']],
		'PHPStan\Rules\Exceptions\TooWideFunctionThrowTypeRule' => [['0120']],
		'PHPStan\Rules\Exceptions\TooWideMethodThrowTypeRule' => [['0121']],
		'PHPStan\Rules\Exceptions\TooWideThrowTypeCheck' => [['0122']],
		'PHPStan\Rules\FunctionCallParametersCheck' => [['0123']],
		'PHPStan\Rules\FunctionDefinitionCheck' => [['0124']],
		'PHPStan\Rules\FunctionReturnTypeCheck' => [['0125']],
		'PHPStan\Rules\Generics\CrossCheckInterfacesHelper' => [['0126']],
		'PHPStan\Rules\Generics\GenericAncestorsCheck' => [['0127']],
		'PHPStan\Rules\Generics\GenericObjectTypeCheck' => [['0128']],
		'PHPStan\Rules\Generics\TemplateTypeCheck' => [['0129']],
		'PHPStan\Rules\Generics\VarianceCheck' => [['0130']],
		'PHPStan\Rules\IssetCheck' => [['0131']],
		'PHPStan\Rules\Methods\MethodCallCheck' => [['0132']],
		'PHPStan\Rules\Methods\StaticMethodCallCheck' => [['0133']],
		'PHPStan\Rules\Methods\MethodSignatureRule' => [['0134']],
		'PHPStan\Rules\Methods\MethodParameterComparisonHelper' => [['0135']],
		'PHPStan\Rules\MissingTypehintCheck' => [['0136']],
		'PHPStan\Rules\NullsafeCheck' => [['0137']],
		'PHPStan\Rules\Constants\AlwaysUsedClassConstantsExtensionProvider' => [['0138']],
		'PHPStan\Rules\Constants\LazyAlwaysUsedClassConstantsExtensionProvider' => [['0138']],
		'PHPStan\Rules\PhpDoc\ConditionalReturnTypeRuleHelper' => [['0139']],
		'PHPStan\Rules\PhpDoc\AssertRuleHelper' => [['0140']],
		'PHPStan\Rules\PhpDoc\UnresolvableTypeHelper' => [['0141']],
		'PHPStan\Rules\PhpDoc\VarTagTypeRuleHelper' => [['0142']],
		'PHPStan\Rules\Playground\NeverRuleHelper' => [['0143']],
		'PHPStan\Rules\Properties\ReadWritePropertiesExtensionProvider' => [['0144']],
		'PHPStan\Rules\Properties\LazyReadWritePropertiesExtensionProvider' => [['0144']],
		'PHPStan\Rules\Properties\PropertyDescriptor' => [['0145']],
		'PHPStan\Rules\Properties\PropertyReflectionFinder' => [['0146']],
		'PHPStan\Rules\RuleLevelHelper' => [['0147']],
		'PHPStan\Rules\UnusedFunctionParametersCheck' => [['0148']],
		'PHPStan\Type\FileTypeMapper' => [['0149']],
		'PHPStan\Type\TypeAliasResolver' => [['0150']],
		'PHPStan\Type\TypeAliasResolverProvider' => [['0151']],
		'PHPStan\Type\BitwiseFlagHelper' => [['0152']],
		...
		'PHPStan\Type\Php\ArgumentBasedFunctionReturnTypeExtension' => [['0153']],
		'PHPStan\Type\Php\ArrayIntersectKeyFunctionReturnTypeExtension' => [['0154']],
		'PHPStan\Type\Php\ArrayChunkFunctionReturnTypeExtension' => [['0155']],
		'PHPStan\Type\Php\ArrayColumnFunctionReturnTypeExtension' => [['0156']],
		'PHPStan\Type\Php\ArrayCombineFunctionReturnTypeExtension' => [['0157']],
		'PHPStan\Type\Php\ArrayCurrentDynamicReturnTypeExtension' => [['0158']],
		'PHPStan\Type\Php\ArrayFillFunctionReturnTypeExtension' => [['0159']],
		'PHPStan\Type\Php\ArrayFillKeysFunctionReturnTypeExtension' => [['0160']],
		'PHPStan\Type\Php\ArrayFilterFunctionReturnTypeReturnTypeExtension' => [['0161']],
		'PHPStan\Type\Php\ArrayFlipFunctionReturnTypeExtension' => [['0162']],
		'PHPStan\Type\Php\ArrayKeyDynamicReturnTypeExtension' => [['0163']],
		...
		'PHPStan\Type\Php\ArrayKeyExistsFunctionTypeSpecifyingExtension' => [['0164']],
		'PHPStan\Type\Php\ArrayKeyFirstDynamicReturnTypeExtension' => [['0165']],
		'PHPStan\Type\Php\ArrayKeyLastDynamicReturnTypeExtension' => [['0166']],
		'PHPStan\Type\Php\ArrayKeysFunctionDynamicReturnTypeExtension' => [['0167']],
		'PHPStan\Type\Php\ArrayMapFunctionReturnTypeExtension' => [['0168']],
		'PHPStan\Type\Php\ArrayMergeFunctionDynamicReturnTypeExtension' => [['0169']],
		'PHPStan\Type\Php\ArrayNextDynamicReturnTypeExtension' => [['0170']],
		'PHPStan\Type\Php\ArrayPopFunctionReturnTypeExtension' => [['0171']],
		'PHPStan\Type\Php\ArrayRandFunctionReturnTypeExtension' => [['0172']],
		'PHPStan\Type\Php\ArrayReduceFunctionReturnTypeExtension' => [['0173']],
		'PHPStan\Type\Php\ArrayReplaceFunctionReturnTypeExtension' => [['0174']],
		'PHPStan\Type\Php\ArrayReverseFunctionReturnTypeExtension' => [['0175']],
		'PHPStan\Type\Php\ArrayShiftFunctionReturnTypeExtension' => [['0176']],
		'PHPStan\Type\Php\ArraySliceFunctionReturnTypeExtension' => [['0177']],
		'PHPStan\Type\Php\ArraySpliceFunctionReturnTypeExtension' => [['0178']],
		'PHPStan\Type\Php\ArraySearchFunctionDynamicReturnTypeExtension' => [['0179']],
		'PHPStan\Type\Php\ArraySearchFunctionTypeSpecifyingExtension' => [['0180']],
		'PHPStan\Type\Php\ArrayValuesFunctionDynamicReturnTypeExtension' => [['0181']],
		'PHPStan\Type\Php\ArraySumFunctionDynamicReturnTypeExtension' => [['0182']],
		'PHPStan\Type\DynamicFunctionThrowTypeExtension' => [['0183', '0222', '0224']],
		'PHPStan\Type\Php\AssertThrowTypeExtension' => [['0183']],
		'PHPStan\Type\DynamicStaticMethodReturnTypeExtension' => [['0184', '0187', '0189', '0201', '0292', '0298']],
		'PHPStan\Type\Php\BackedEnumFromMethodDynamicReturnTypeExtension' => [['0184']],
		'PHPStan\Type\Php\Base64DecodeDynamicFunctionReturnTypeExtension' => [['0185']],
		'PHPStan\Type\Php\BcMathStringOrNullReturnTypeExtension' => [['0186']],
		'PHPStan\Type\Php\ClosureBindDynamicReturnTypeExtension' => [['0187']],
		'PHPStan\Type\Php\ClosureBindToDynamicReturnTypeExtension' => [['0188']],
		'PHPStan\Type\Php\ClosureFromCallableDynamicReturnTypeExtension' => [['0189']],
		'PHPStan\Type\Php\CompactFunctionReturnTypeExtension' => [['0190']],
		'PHPStan\Type\Php\ConstantFunctionReturnTypeExtension' => [['0191']],
		'PHPStan\Type\Php\ConstantHelper' => [['0192']],
		'PHPStan\Type\Php\CountFunctionReturnTypeExtension' => [['0193']],
		'PHPStan\Type\Php\CountFunctionTypeSpecifyingExtension' => [['0194']],
		'PHPStan\Type\Php\CurlGetinfoFunctionDynamicReturnTypeExtension' => [['0195']],
		'PHPStan\Type\Php\CurlInitReturnTypeExtension' => [['0196']],
		'PHPStan\Type\Php\DateFormatFunctionReturnTypeExtension' => [['0197']],
		'PHPStan\Type\Php\DateFormatMethodReturnTypeExtension' => [['0198']],
		'PHPStan\Type\Php\DateFunctionReturnTypeExtension' => [['0199']],
		'PHPStan\Type\DynamicStaticMethodThrowTypeExtension' => [
			['0200', '0206', '0207', '0225', '0226', '0227', '0228', '0231'],
		],
		'PHPStan\Type\Php\DateIntervalConstructorThrowTypeExtension' => [['0200']],
		'PHPStan\Type\Php\DateIntervalDynamicReturnTypeExtension' => [['0201']],
		'PHPStan\Type\Php\DateTimeCreateDynamicReturnTypeExtension' => [['0202']],
		'PHPStan\Type\Php\DateTimeDynamicReturnTypeExtension' => [['0203']],
		'PHPStan\Type\Php\DateTimeModifyReturnTypeExtension' => [['0204', '0205']],
		'PHPStan\Type\Php\DateTimeConstructorThrowTypeExtension' => [['0206']],
		'PHPStan\Type\Php\DateTimeZoneConstructorThrowTypeExtension' => [['0207']],
		'PHPStan\Type\Php\DsMapDynamicReturnTypeExtension' => [['0208']],
		'PHPStan\Type\DynamicMethodThrowTypeExtension' => [['0209']],
		'PHPStan\Type\Php\DsMapDynamicMethodThrowTypeExtension' => [['0209']],
		'PHPStan\Type\Php\DioStatDynamicFunctionReturnTypeExtension' => [['0210']],
		'PHPStan\Type\Php\ExplodeFunctionDynamicReturnTypeExtension' => [['0211']],
		'PHPStan\Type\Php\FilterFunctionReturnTypeHelper' => [['0212']],
		'PHPStan\Type\Php\FilterInputDynamicReturnTypeExtension' => [['0213']],
		'PHPStan\Type\Php\FilterVarDynamicReturnTypeExtension' => [['0214']],
		'PHPStan\Type\Php\FilterVarArrayDynamicReturnTypeExtension' => [['0215']],
		'PHPStan\Type\Php\GetCalledClassDynamicReturnTypeExtension' => [['0216']],
		'PHPStan\Type\Php\GetClassDynamicReturnTypeExtension' => [['0217']],
		'PHPStan\Type\Php\GetParentClassDynamicFunctionReturnTypeExtension' => [['0218']],
		'PHPStan\Type\Php\GettypeFunctionReturnTypeExtension' => [['0219']],
		'PHPStan\Type\Php\GettimeofdayDynamicFunctionReturnTypeExtension' => [['0220']],
		'PHPStan\Type\Php\HashFunctionsReturnTypeExtension' => [['0221']],
		'PHPStan\Type\Php\IntdivThrowTypeExtension' => [['0222']],
		'PHPStan\Type\Php\IniGetReturnTypeExtension' => [['0223']],
		'PHPStan\Type\Php\JsonThrowTypeExtension' => [['0224']],
		...
		'PHPStan\Type\Php\ReflectionMethodConstructorThrowTypeExtension' => [['0227']],
		'PHPStan\Type\Php\ReflectionPropertyConstructorThrowTypeExtension' => [['0228']],
		'PHPStan\Type\Php\StrContainingTypeSpecifyingExtension' => [['0229']],
		'PHPStan\Type\Php\SimpleXMLElementClassPropertyReflectionExtension' => [['0230']],
		'PHPStan\Type\Php\SimpleXMLElementConstructorThrowTypeExtension' => [['0231']],
		'PHPStan\Type\Php\StatDynamicReturnTypeExtension' => [['0232']],
		'PHPStan\Type\Php\MethodExistsTypeSpecifyingExtension' => [['0233']],
		'PHPStan\Type\Php\PropertyExistsTypeSpecifyingExtension' => [['0234']],
		'PHPStan\Type\Php\MinMaxFunctionReturnTypeExtension' => [['0235']],
		'PHPStan\Type\Php\NumberFormatFunctionDynamicReturnTypeExtension' => [['0236']],
		'PHPStan\Type\Php\PathinfoFunctionDynamicReturnTypeExtension' => [['0237']],
		'PHPStan\Type\Php\PregFilterFunctionReturnTypeExtension' => [['0238']],
		'PHPStan\Type\Php\PregSplitDynamicReturnTypeExtension' => [['0239']],
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [['0240']],
		'PHPStan\Type\Php\ReflectionClassIsSubclassOfTypeSpecifyingExtension' => [['0240']],
		'PHPStan\Type\Php\ReplaceFunctionsDynamicReturnTypeExtension' => [['0241']],
		'PHPStan\Type\Php\ArrayPointerFunctionsDynamicReturnTypeExtension' => [['0242']],
		'PHPStan\Type\Php\LtrimFunctionReturnTypeExtension' => [['0243']],
		'PHPStan\Type\Php\MbFunctionsReturnTypeExtension' => [['0244']],
		'PHPStan\Type\Php\MbConvertEncodingFunctionReturnTypeExtension' => [['0245']],
		'PHPStan\Type\Php\MbSubstituteCharacterDynamicReturnTypeExtension' => [['0246']],
		'PHPStan\Type\Php\MbStrlenFunctionReturnTypeExtension' => [['0247']],
		'PHPStan\Type\Php\MicrotimeFunctionReturnTypeExtension' => [['0248']],
		'PHPStan\Type\Php\HrtimeFunctionReturnTypeExtension' => [['0249']],
		'PHPStan\Type\Php\ImplodeFunctionReturnTypeExtension' => [['0250']],
		'PHPStan\Type\Php\NonEmptyStringFunctionsReturnTypeExtension' => [['0251']],
		'PHPStan\Type\Php\StrCaseFunctionsReturnTypeExtension' => [['0252']],
		'PHPStan\Type\Php\StrlenFunctionReturnTypeExtension' => [['0253']],
		'PHPStan\Type\Php\StrIncrementDecrementFunctionReturnTypeExtension' => [['0254']],
		'PHPStan\Type\Php\StrPadFunctionReturnTypeExtension' => [['0255']],
		'PHPStan\Type\Php\StrRepeatFunctionReturnTypeExtension' => [['0256']],
		'PHPStan\Type\Php\SubstrDynamicReturnTypeExtension' => [['0257']],
		'PHPStan\Type\Php\ThrowableReturnTypeExtension' => [['0258']],
		'PHPStan\Type\Php\ParseUrlFunctionDynamicReturnTypeExtension' => [['0259']],
		'PHPStan\Type\Php\TriggerErrorDynamicReturnTypeExtension' => [['0260']],
		'PHPStan\Type\Php\VersionCompareFunctionDynamicReturnTypeExtension' => [['0261']],
		'PHPStan\Type\Php\PowFunctionReturnTypeExtension' => [['0262']],
		'PHPStan\Type\Php\RoundFunctionReturnTypeExtension' => [['0263']],
		'PHPStan\Type\Php\StrtotimeFunctionReturnTypeExtension' => [['0264']],
		'PHPStan\Type\Php\RandomIntFunctionReturnTypeExtension' => [['0265']],
		'PHPStan\Type\Php\RangeFunctionReturnTypeExtension' => [['0266']],
		'PHPStan\Type\Php\AssertFunctionTypeSpecifyingExtension' => [['0267']],
		...
		'PHPStan\Type\Php\DefineConstantTypeSpecifyingExtension' => [['0270']],
		'PHPStan\Type\Php\DefinedConstantTypeSpecifyingExtension' => [['0271']],
		'PHPStan\Type\Php\FunctionExistsFunctionTypeSpecifyingExtension' => [['0272']],
		'PHPStan\Type\Php\InArrayFunctionTypeSpecifyingExtension' => [['0273']],
		'PHPStan\Type\Php\IsArrayFunctionTypeSpecifyingExtension' => [['0274']],
		'PHPStan\Type\Php\IsCallableFunctionTypeSpecifyingExtension' => [['0275']],
		'PHPStan\Type\Php\IsIterableFunctionTypeSpecifyingExtension' => [['0276']],
		'PHPStan\Type\Php\IsSubclassOfFunctionTypeSpecifyingExtension' => [['0277']],
		'PHPStan\Type\Php\IteratorToArrayFunctionReturnTypeExtension' => [['0278']],
		'PHPStan\Type\Php\IsAFunctionTypeSpecifyingExtension' => [['0279']],
		'PHPStan\Type\Php\IsAFunctionTypeSpecifyingHelper' => [['0280']],
		'PHPStan\Type\Php\CtypeDigitFunctionTypeSpecifyingExtension' => [['0281']],
		'PHPStan\Type\Php\JsonThrowOnErrorDynamicReturnTypeExtension' => [['0282']],
		'PHPStan\Type\Php\TypeSpecifyingFunctionsDynamicReturnTypeExtension' => [['0283']],
		'PHPStan\Type\Php\SimpleXMLElementAsXMLMethodReturnTypeExtension' => [['0284']],
		'PHPStan\Type\Php\SimpleXMLElementXpathMethodReturnTypeExtension' => [['0285']],
		'PHPStan\Type\Php\StrSplitFunctionReturnTypeExtension' => [['0286']],
		'PHPStan\Type\Php\StrTokFunctionReturnTypeExtension' => [['0287']],
		'PHPStan\Type\Php\SprintfFunctionDynamicReturnTypeExtension' => [['0288']],
		'PHPStan\Type\Php\SscanfFunctionDynamicReturnTypeExtension' => [['0289']],
		'PHPStan\Type\Php\StrvalFamilyFunctionReturnTypeExtension' => [['0290']],
		'PHPStan\Type\Php\StrWordCountFunctionDynamicReturnTypeExtension' => [['0291']],
		'PHPStan\Type\Php\XMLReaderOpenReturnTypeExtension' => [['0292']],
		'PHPStan\Type\Php\ReflectionGetAttributesMethodReturnTypeExtension' => [['0293', '0294', '0295', '0296', '0297']],
		'PHPStan\Type\Php\DatePeriodConstructorReturnTypeExtension' => [['0298']],
		'PHPStan\Type\ClosureTypeFactory' => [['0299']],
		'PHPStan\Type\Constant\OversizedArrayBuilder' => [['0300']],
		...
		'PHPStan\Reflection\BetterReflection\BetterReflectionSourceLocatorFactory' => [['0301']],
		'PHPStan\Reflection\BetterReflection\BetterReflectionProviderFactory' => [['0302']],
		'PHPStan\Reflection\BetterReflection\SourceStubber\PhpStormStubsSourceStubberFactory' => [['0303']],
		'PHPStan\BetterReflection\SourceLocator\SourceStubber\SourceStubber' => [1 => ['0304', '0305']],
		'PHPStan\BetterReflection\SourceLocator\SourceStubber\PhpStormStubsSourceStubber' => [['0304']],
		'PHPStan\BetterReflection\SourceLocator\SourceStubber\ReflectionSourceStubber' => [['0305']],
		...
		'PHPStan\Command\ErrorFormatter\CiDetectedErrorFormatter' => [['0306']],
		...
		'PHPStan\Rules\Api\ApiClassConstFetchRule' => [['0307']],
		'PHPStan\Rules\Api\ApiInstanceofRule' => [['0308']],
		'PHPStan\Rules\Api\ApiInstanceofTypeRule' => [['0309']],
		'PHPStan\Rules\Api\NodeConnectingVisitorAttributesRule' => [['0310']],
		'PHPStan\Rules\Api\RuntimeReflectionFunctionRule' => [['0311']],
		'PHPStan\Rules\Api\RuntimeReflectionInstantiationRule' => [['0312']],
		'PHPStan\Rules\Classes\ExistingClassInClassExtendsRule' => [['0313']],
		'PHPStan\Rules\Classes\ExistingClassInInstanceOfRule' => [['0314']],
		'PHPStan\Rules\Exceptions\CaughtExceptionExistenceRule' => [['0315']],
		'PHPStan\Rules\Functions\CallToNonExistentFunctionRule' => [['0316']],
		'PHPStan\Rules\Constants\OverridingConstantRule' => [['0317']],
		'PHPStan\Rules\Methods\OverridingMethodRule' => [['0318']],
		'PHPStan\Rules\Methods\ConsistentConstructorRule' => [['0319']],
		'PHPStan\Rules\Missing\MissingReturnRule' => [['0320']],
		'PHPStan\Rules\Namespaces\ExistingNamesInGroupUseRule' => [['0321']],
		'PHPStan\Rules\Namespaces\ExistingNamesInUseRule' => [['0322']],
		'PHPStan\Rules\Operators\InvalidIncDecOperationRule' => [['0323']],
		'PHPStan\Rules\Properties\AccessPropertiesRule' => [['0324']],
		'PHPStan\Rules\Properties\AccessStaticPropertiesRule' => [['0325']],
		'PHPStan\Rules\Properties\ExistingClassesInPropertiesRule' => [['0326']],
		'PHPStan\Rules\Functions\FunctionCallableRule' => [['0327']],
		'PHPStan\Rules\Properties\MissingReadOnlyByPhpDocPropertyAssignRule' => [['0328']],
		'PHPStan\Rules\Properties\OverridingPropertyRule' => [['0329']],
		'PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyRule' => [['0330']],
		'PHPStan\Rules\Properties\UninitializedPropertyRule' => [['0331']],
		'PHPStan\Rules\Properties\WritingToReadOnlyPropertiesRule' => [['0332']],
		'PHPStan\Rules\Properties\ReadingWriteOnlyPropertiesRule' => [['0333']],
		'PHPStan\Rules\Variables\CompactVariablesRule' => [['0334']],
		'PHPStan\Rules\Variables\DefinedVariableRule' => [['0335']],
		'PHPStan\Rules\Regexp\RegularExpressionPatternRule' => [['0336']],
		'PHPStan\Reflection\ConstructorsHelper' => [['0337']],
		'PHPStan\Rules\Methods\MissingMagicSerializationMethodsRule' => [['0338']],
		'PHPStan\Rules\Constants\MagicConstantContextRule' => [['0339']],
		'PHPStan\Rules\Classes\MixinRule' => [['0340']],
		'PHPStan\Rules\PhpDoc\RequireExtendsCheck' => [['0341']],
		'PHPStan\Rules\PhpDoc\RequireImplementsDefinitionTraitRule' => [['0342']],
		'PHPStan\Rules\Functions\IncompatibleArrowFunctionDefaultParameterTypeRule' => [['0343']],
		'PHPStan\Rules\Functions\IncompatibleClosureDefaultParameterTypeRule' => [['0344']],
		'PHPStan\Rules\Functions\CallCallablesRule' => [['0345']],
		'PHPStan\Rules\Methods\IllegalConstructorMethodCallRule' => [['0346']],
		'PHPStan\Rules\Methods\IllegalConstructorStaticCallRule' => [['0347']],
		'PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule' => [['0348']],
		'PHPStan\Rules\PhpDoc\InvalidPhpDocVarTagTypeRule' => [['0349']],
		'PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule' => [['0350']],
		'PHPStan\Rules\PhpDoc\VarTagChangedExpressionTypeRule' => [['0351']],
		'PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule' => [['0352']],
		'PHPStan\Rules\Generics\PropertyVarianceRule' => [['0353']],
		'PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule' => [['0354']],
		'PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule' => [['0355']],
		'PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule' => [['0356']],
		'PHPStan\Rules\Exceptions\ThrowsVoidFunctionWithExplicitThrowPointRule' => [['0357']],
		'PHPStan\Rules\Exceptions\ThrowsVoidMethodWithExplicitThrowPointRule' => [['0358']],
		'PHPStan\Rules\Generators\YieldFromTypeRule' => [['0359']],
		'PHPStan\Rules\Generators\YieldInGeneratorRule' => [['0360']],
		'PHPStan\Rules\Arrays\ArrayUnpackingRule' => [['0361']],
		'PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRefRule' => [['0362']],
		'PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRule' => [['0363']],
		'PHPStan\Rules\Classes\ImpossibleInstanceOfRule' => [['0364']],
		'PHPStan\Rules\Comparison\BooleanAndConstantConditionRule' => [['0365']],
		'PHPStan\Rules\Comparison\BooleanOrConstantConditionRule' => [['0366']],
		'PHPStan\Rules\Comparison\BooleanNotConstantConditionRule' => [['0367']],
		'PHPStan\Rules\DeadCode\NoopRule' => [['0368']],
		'PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule' => [['0369']],
		'PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule' => [['0370']],
		'PHPStan\Rules\Comparison\ElseIfConstantConditionRule' => [['0371']],
		'PHPStan\Rules\Comparison\IfConstantConditionRule' => [['0372']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule' => [['0373']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule' => [['0374']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule' => [['0375']],
		'PHPStan\Rules\Comparison\LogicalXorConstantConditionRule' => [['0376']],
		'PHPStan\Rules\Comparison\MatchExpressionRule' => [['0377']],
		'PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule' => [['0378']],
		'PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule' => [['0379']],
		'PHPStan\Rules\Comparison\ConstantLooseComparisonRule' => [['0380']],
		'PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule' => [['0381']],
		'PHPStan\Rules\Comparison\UnreachableIfBranchesRule' => [['0382']],
		'PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule' => [['0383']],
		'PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule' => [['0384']],
		'PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule' => [['0385']],
		'PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule' => [['0386']],
		'PHPStan\Rules\Properties\NullsafePropertyFetchRule' => [['0387']],
		'PHPStan\Collectors\Collector' => [['0388', '0389']],
		'PHPStan\Rules\Traits\TraitDeclarationCollector' => [['0388']],
		'PHPStan\Rules\Traits\TraitUseCollector' => [['0389']],
		'PHPStan\Rules\Traits\NotAnalysedTraitRule' => [['0390']],
		'PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule' => [['0391']],
		'PHPStan\Rules\Functions\RandomIntParametersRule' => [['0392']],
		'PHPStan\Rules\Functions\ArrayFilterRule' => [['0393']],
		'PHPStan\Rules\Functions\CallUserFuncRule' => [['0394']],
		'Spaze\PHPStan\Rules\Disallowed\Allowed\Allowed' => [['0395']],
		'Spaze\PHPStan\Rules\Disallowed\Allowed\AllowedPath' => [['0396']],
		'Spaze\PHPStan\Rules\Disallowed\DisallowedAttributeFactory' => [['0397']],
		'Spaze\PHPStan\Rules\Disallowed\DisallowedCallFactory' => [['0398']],
		'Spaze\PHPStan\Rules\Disallowed\DisallowedConstantFactory' => [['0399']],
		'Spaze\PHPStan\Rules\Disallowed\DisallowedNamespaceFactory' => [['0400']],
		'Spaze\PHPStan\Rules\Disallowed\DisallowedVariableFactory' => [['0401']],
		'Spaze\PHPStan\Rules\Disallowed\DisallowedSuperglobalFactory' => [['0401']],
		'Spaze\PHPStan\Rules\Disallowed\File\FilePath' => [['0402']],
		'Spaze\PHPStan\Rules\Disallowed\Formatter\Formatter' => [['0403']],
		'Spaze\PHPStan\Rules\Disallowed\Identifier\Identifier' => [['0404']],
		'Spaze\PHPStan\Rules\Disallowed\Normalizer\Normalizer' => [['0405']],
		'Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedAttributeRuleErrors' => [['0406']],
		'Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedConstantRuleErrors' => [['0407']],
		'Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedMethodRuleErrors' => [['0408']],
		'Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedNamespaceRuleErrors' => [['0409']],
		'Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedCallsRuleErrors' => [['0410']],
		'Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedVariableRuleErrors' => [['0411']],
		'Spaze\PHPStan\Rules\Disallowed\Type\TypeResolver' => [['0412']],
		'Spaze\PHPStan\Rules\Disallowed\Usages\NamespaceUsages' => [['0413', '0414']],
		'Spaze\PHPStan\Rules\Disallowed\Calls\MethodCalls' => [['0415']],
		'Spaze\PHPStan\Rules\Disallowed\Calls\NewCalls' => [['0416']],
		'Spaze\PHPStan\Rules\Disallowed\Calls\StaticCalls' => [['0417']],
		'Spaze\PHPStan\Rules\Disallowed\Calls\EvalCalls' => [['0418']],
		'Spaze\PHPStan\Rules\Disallowed\Calls\EchoCalls' => [['0419']],
		'Spaze\PHPStan\Rules\Disallowed\Calls\PrintCalls' => [['0420']],
		'Spaze\PHPStan\Rules\Disallowed\Calls\EmptyCalls' => [['0421']],
		'Spaze\PHPStan\Rules\Disallowed\Calls\ExitDieCalls' => [['0422']],
		'Spaze\PHPStan\Rules\Disallowed\Calls\FunctionCalls' => [['0423']],
		'Spaze\PHPStan\Rules\Disallowed\Calls\ShellExecCalls' => [['0424']],
		'Spaze\PHPStan\Rules\Disallowed\Usages\ConstantUsages' => [['0425']],
		'Spaze\PHPStan\Rules\Disallowed\Usages\ClassConstantUsages' => [['classConstantUsages', '0426']],
		'Spaze\PHPStan\Rules\Disallowed\Usages\VariableUsages' => [['0427']],
		'Spaze\PHPStan\Rules\Disallowed\Usages\AttributeUsages' => [['0428']],
	];
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, ['/ipp-php/vendor/phpstan/phpstan/..', '/ipp-php']);
	}
	...
	{
		return new PHPStan\PhpDoc\PhpDocInheritanceResolver($this->getService('0149'), $this->getService('stubPhpDocProvider'));
	}


	public function createService029(): PHPStan\PhpDoc\PhpDocNodeResolver
	{
		return new PHPStan\PhpDoc\PhpDocNodeResolver($this->getService('032'), $this->getService('031'), $this->getService('0141'));
	}
	...
	public function createService037(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			$this->getService('061'),
			[
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionAttribute.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClass.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClassConstant.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionFunctionAbstract.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionMethod.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionParameter.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionProperty.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/iterable.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ArrayObject.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/WeakReference.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ext-ds.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ImagickPixel.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/PDOStatement.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/date.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/ibm_db2.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/mysqli.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/zip.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/dom.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/spl.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/SplObjectStorage.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/Exception.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/arrayFunctions.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/core.stub',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/typeCheckingFunctions.stub',
			],
			'/ipp-php'
		);
	}
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_b402e2e175 $container)
			{
			...
			public function create(): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/ipp-php/tmp/resultCache.php',
					$this->container->getParameter('analysedPaths'),
					['/ipp-php/vendor/phpstan/phpstan/..', '/ipp-php'],
					'9',
					null,
					[
						'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
						'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionAttribute.php',
						'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/Attribute.php',
						'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionIntersectionType.php',
					],
					[],
					[],
					false
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/ipp-php/tmp/resultCache.php');
	}
	...
	{
		return new PHPStan\Dependency\ExportedNodeResolver($this->getService('0149'), $this->getService('017'));
	}
	...
	public function createService063(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/ipp-php',
			'/ipp-php/tmp',
			['phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon', '/ipp-php/phpstan.neon'],
			$this->getParameter('analysedPaths'),
			['/ipp-php/vendor/phpstan/phpstan/..', '/ipp-php'],
	...
	{
		return new PHPStan\File\FileHelper('/ipp-php');
	}
	...
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchCheck($this->getService('0147'), true, false);
	}


	public function createService0112(): PHPStan\Rules\ClassCaseSensitivityCheck
	{
		return new PHPStan\Rules\ClassCaseSensitivityCheck($this->getService('reflectionProvider'), false);
	}


	public function createService0113(): PHPStan\Rules\Classes\LocalTypeAliasesCheck
	{
		return new PHPStan\Rules\Classes\LocalTypeAliasesCheck([], $this->getService('reflectionProvider'), $this->getService('032'));
	}


	public function createService0114(): PHPStan\Rules\Comparison\ConstantConditionRuleHelper
	{
		return new PHPStan\Rules\Comparison\ConstantConditionRuleHelper($this->getService('0115'), true, false);
	}


	public function createService0115(): PHPStan\Rules\Comparison\ImpossibleCheckTypeHelper
	{
	...
	public function createService0116(): PHPStan\Rules\Exceptions\DefaultExceptionTypeResolver
	{
		return new PHPStan\Rules\Exceptions\DefaultExceptionTypeResolver($this->getService('reflectionProvider'), [], [], [], []);
	}


	public function createService0117(): PHPStan\Rules\Exceptions\MissingCheckedExceptionInFunctionThrowsRule
	{
		return new PHPStan\Rules\Exceptions\MissingCheckedExceptionInFunctionThrowsRule($this->getService('0119'));
	}


	public function createService0118(): PHPStan\Rules\Exceptions\MissingCheckedExceptionInMethodThrowsRule
	{
		return new PHPStan\Rules\Exceptions\MissingCheckedExceptionInMethodThrowsRule($this->getService('0119'));
	}


	public function createService0119(): PHPStan\Rules\Exceptions\MissingCheckedExceptionInThrowsCheck
	{
		return new PHPStan\Rules\Exceptions\MissingCheckedExceptionInThrowsCheck($this->getService('exceptionTypeResolver'));
	}


	public function createService0120(): PHPStan\Rules\Exceptions\TooWideFunctionThrowTypeRule
	{
		return new PHPStan\Rules\Exceptions\TooWideFunctionThrowTypeRule($this->getService('0122'));
	}


	public function createService0121(): PHPStan\Rules\Exceptions\TooWideMethodThrowTypeRule
	{
		return new PHPStan\Rules\Exceptions\TooWideMethodThrowTypeRule($this->getService('0149'), $this->getService('0122'));
	}
	...
	public function createService0123(): PHPStan\Rules\FunctionCallParametersCheck
	{
	...
	public function createService0124(): PHPStan\Rules\FunctionDefinitionCheck
	{
	...
	public function createService0125(): PHPStan\Rules\FunctionReturnTypeCheck
	{
		return new PHPStan\Rules\FunctionReturnTypeCheck($this->getService('0147'));
	}


	public function createService0126(): PHPStan\Rules\Generics\CrossCheckInterfacesHelper
	{
		return new PHPStan\Rules\Generics\CrossCheckInterfacesHelper;
	}


	public function createService0127(): PHPStan\Rules\Generics\GenericAncestorsCheck
	{
	...
	public function createService0128(): PHPStan\Rules\Generics\GenericObjectTypeCheck
	{
		return new PHPStan\Rules\Generics\GenericObjectTypeCheck;
	}


	public function createService0129(): PHPStan\Rules\Generics\TemplateTypeCheck
	{
	...
	public function createService0130(): PHPStan\Rules\Generics\VarianceCheck
	{
		return new PHPStan\Rules\Generics\VarianceCheck(false, false);
	}


	public function createService0131(): PHPStan\Rules\IssetCheck
	{
		return new PHPStan\Rules\IssetCheck($this->getService('0145'), $this->getService('0146'), true, true, false);
	}


	public function createService0132(): PHPStan\Rules\Methods\MethodCallCheck
	{
	...
	public function createService0133(): PHPStan\Rules\Methods\StaticMethodCallCheck
	{
	...
	public function createService0134(): PHPStan\Rules\Methods\MethodSignatureRule
	{
		return new PHPStan\Rules\Methods\MethodSignatureRule($this->getService('095'), false, false, false);
	}


	public function createService0135(): PHPStan\Rules\Methods\MethodParameterComparisonHelper
	{
		return new PHPStan\Rules\Methods\MethodParameterComparisonHelper($this->getService('020'), false);
	}


	public function createService0136(): PHPStan\Rules\MissingTypehintCheck
	{
	...
	public function createService0137(): PHPStan\Rules\NullsafeCheck
	{
		return new PHPStan\Rules\NullsafeCheck;
	}


	public function createService0138(): PHPStan\Rules\Constants\LazyAlwaysUsedClassConstantsExtensionProvider
	{
		return new PHPStan\Rules\Constants\LazyAlwaysUsedClassConstantsExtensionProvider($this->getService('061'));
	}


	public function createService0139(): PHPStan\Rules\PhpDoc\ConditionalReturnTypeRuleHelper
	{
		return new PHPStan\Rules\PhpDoc\ConditionalReturnTypeRuleHelper;
	}


	public function createService0140(): PHPStan\Rules\PhpDoc\AssertRuleHelper
	{
		return new PHPStan\Rules\PhpDoc\AssertRuleHelper($this->getService('080'));
	}


	public function createService0141(): PHPStan\Rules\PhpDoc\UnresolvableTypeHelper
	{
		return new PHPStan\Rules\PhpDoc\UnresolvableTypeHelper;
	}


	public function createService0142(): PHPStan\Rules\PhpDoc\VarTagTypeRuleHelper
	{
		return new PHPStan\Rules\PhpDoc\VarTagTypeRuleHelper(false);
	}


	public function createService0143(): PHPStan\Rules\Playground\NeverRuleHelper
	{
		return new PHPStan\Rules\Playground\NeverRuleHelper;
	}


	public function createService0144(): PHPStan\Rules\Properties\LazyReadWritePropertiesExtensionProvider
	{
		return new PHPStan\Rules\Properties\LazyReadWritePropertiesExtensionProvider($this->getService('061'));
	}


	public function createService0145(): PHPStan\Rules\Properties\PropertyDescriptor
	{
		return new PHPStan\Rules\Properties\PropertyDescriptor;
	}


	public function createService0146(): PHPStan\Rules\Properties\PropertyReflectionFinder
	{
		return new PHPStan\Rules\Properties\PropertyReflectionFinder;
	}


	public function createService0147(): PHPStan\Rules\RuleLevelHelper
	{
		return new PHPStan\Rules\RuleLevelHelper($this->getService('reflectionProvider'), true, false, true, true, false, false, false);
	}


	public function createService0148(): PHPStan\Rules\UnusedFunctionParametersCheck
	{
		return new PHPStan\Rules\UnusedFunctionParametersCheck($this->getService('reflectionProvider'));
	}


	public function createService0149(): PHPStan\Type\FileTypeMapper
	{
	...
	public function createService0150(): PHPStan\Type\TypeAliasResolver
	{
	...
	public function createService0151(): PHPStan\Type\TypeAliasResolverProvider
	{
		return new PHPStan\Type\LazyTypeAliasResolverProvider($this->getService('061'));
	}


	public function createService0152(): PHPStan\Type\BitwiseFlagHelper
	{
		return new PHPStan\Type\BitwiseFlagHelper($this->getService('reflectionProvider'));
	}


	public function createService0153(): PHPStan\Type\Php\ArgumentBasedFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArgumentBasedFunctionReturnTypeExtension;
	}


	public function createService0154(): PHPStan\Type\Php\ArrayIntersectKeyFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayIntersectKeyFunctionReturnTypeExtension($this->getService('020'));
	}


	public function createService0155(): PHPStan\Type\Php\ArrayChunkFunctionReturnTypeExtension
	{
	...
	public function createService0157(): PHPStan\Type\Php\ArrayCombineFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayCombineFunctionReturnTypeExtension($this->getService('020'));
	}


	public function createService0158(): PHPStan\Type\Php\ArrayCurrentDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayCurrentDynamicReturnTypeExtension;
	}


	public function createService0159(): PHPStan\Type\Php\ArrayFillFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayFillFunctionReturnTypeExtension($this->getService('020'));
	}


	public function createService0160(): PHPStan\Type\Php\ArrayFillKeysFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayFillKeysFunctionReturnTypeExtension($this->getService('020'));
	}


	public function createService0161(): PHPStan\Type\Php\ArrayFilterFunctionReturnTypeReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayFilterFunctionReturnTypeReturnTypeExtension;
	}


	public function createService0162(): PHPStan\Type\Php\ArrayFlipFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayFlipFunctionReturnTypeExtension($this->getService('020'));
	}


	public function createService0163(): PHPStan\Type\Php\ArrayKeyDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayKeyDynamicReturnTypeExtension;
	}


	public function createService0164(): PHPStan\Type\Php\ArrayKeyExistsFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\ArrayKeyExistsFunctionTypeSpecifyingExtension;
	}


	public function createService0165(): PHPStan\Type\Php\ArrayKeyFirstDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayKeyFirstDynamicReturnTypeExtension;
	}


	public function createService0166(): PHPStan\Type\Php\ArrayKeyLastDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayKeyLastDynamicReturnTypeExtension;
	}


	public function createService0167(): PHPStan\Type\Php\ArrayKeysFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayKeysFunctionDynamicReturnTypeExtension($this->getService('020'));
	}


	public function createService0168(): PHPStan\Type\Php\ArrayMapFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayMapFunctionReturnTypeExtension;
	}


	public function createService0169(): PHPStan\Type\Php\ArrayMergeFunctionDynamicReturnTypeExtension
	{
	...
	public function createService0171(): PHPStan\Type\Php\ArrayPopFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayPopFunctionReturnTypeExtension;
	}


	public function createService0172(): PHPStan\Type\Php\ArrayRandFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayRandFunctionReturnTypeExtension;
	}


	public function createService0173(): PHPStan\Type\Php\ArrayReduceFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayReduceFunctionReturnTypeExtension;
	}


	public function createService0174(): PHPStan\Type\Php\ArrayReplaceFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayReplaceFunctionReturnTypeExtension;
	}


	public function createService0175(): PHPStan\Type\Php\ArrayReverseFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayReverseFunctionReturnTypeExtension;
	}


	public function createService0176(): PHPStan\Type\Php\ArrayShiftFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayShiftFunctionReturnTypeExtension;
	}


	public function createService0177(): PHPStan\Type\Php\ArraySliceFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArraySliceFunctionReturnTypeExtension;
	}


	public function createService0178(): PHPStan\Type\Php\ArraySpliceFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArraySpliceFunctionReturnTypeExtension;
	}


	public function createService0179(): PHPStan\Type\Php\ArraySearchFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArraySearchFunctionDynamicReturnTypeExtension($this->getService('020'));
	}


	public function createService0180(): PHPStan\Type\Php\ArraySearchFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\ArraySearchFunctionTypeSpecifyingExtension;
	}


	public function createService0181(): PHPStan\Type\Php\ArrayValuesFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayValuesFunctionDynamicReturnTypeExtension($this->getService('020'));
	}


	public function createService0182(): PHPStan\Type\Php\ArraySumFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArraySumFunctionDynamicReturnTypeExtension;
	}


	public function createService0183(): PHPStan\Type\Php\AssertThrowTypeExtension
	{
		return new PHPStan\Type\Php\AssertThrowTypeExtension;
	}


	public function createService0184(): PHPStan\Type\Php\BackedEnumFromMethodDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\BackedEnumFromMethodDynamicReturnTypeExtension;
	}


	public function createService0185(): PHPStan\Type\Php\Base64DecodeDynamicFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\Base64DecodeDynamicFunctionReturnTypeExtension;
	}


	public function createService0186(): PHPStan\Type\Php\BcMathStringOrNullReturnTypeExtension
	{
		return new PHPStan\Type\Php\BcMathStringOrNullReturnTypeExtension($this->getService('020'));
	}


	public function createService0187(): PHPStan\Type\Php\ClosureBindDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ClosureBindDynamicReturnTypeExtension;
	}


	public function createService0188(): PHPStan\Type\Php\ClosureBindToDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ClosureBindToDynamicReturnTypeExtension;
	}


	public function createService0189(): PHPStan\Type\Php\ClosureFromCallableDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ClosureFromCallableDynamicReturnTypeExtension;
	}


	public function createService0190(): PHPStan\Type\Php\CompactFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\CompactFunctionReturnTypeExtension(true);
	}


	public function createService0191(): PHPStan\Type\Php\ConstantFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ConstantFunctionReturnTypeExtension($this->getService('0192'));
	}


	public function createService0192(): PHPStan\Type\Php\ConstantHelper
	{
		return new PHPStan\Type\Php\ConstantHelper;
	}


	public function createService0193(): PHPStan\Type\Php\CountFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\CountFunctionReturnTypeExtension;
	}


	public function createService0194(): PHPStan\Type\Php\CountFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\CountFunctionTypeSpecifyingExtension;
	}


	public function createService0195(): PHPStan\Type\Php\CurlGetinfoFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\CurlGetinfoFunctionDynamicReturnTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0196(): PHPStan\Type\Php\CurlInitReturnTypeExtension
	{
		return new PHPStan\Type\Php\CurlInitReturnTypeExtension;
	}


	public function createService0197(): PHPStan\Type\Php\DateFormatFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\DateFormatFunctionReturnTypeExtension;
	}


	public function createService0198(): PHPStan\Type\Php\DateFormatMethodReturnTypeExtension
	{
		return new PHPStan\Type\Php\DateFormatMethodReturnTypeExtension;
	}


	public function createService0199(): PHPStan\Type\Php\DateFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\DateFunctionReturnTypeExtension;
	}


	public function createService0200(): PHPStan\Type\Php\DateIntervalConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\DateIntervalConstructorThrowTypeExtension;
	}


	public function createService0201(): PHPStan\Type\Php\DateIntervalDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\DateIntervalDynamicReturnTypeExtension;
	}


	public function createService0202(): PHPStan\Type\Php\DateTimeCreateDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\DateTimeCreateDynamicReturnTypeExtension;
	}


	public function createService0203(): PHPStan\Type\Php\DateTimeDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\DateTimeDynamicReturnTypeExtension;
	}


	public function createService0204(): PHPStan\Type\Php\DateTimeModifyReturnTypeExtension
	{
		return new PHPStan\Type\Php\DateTimeModifyReturnTypeExtension('DateTime');
	}


	public function createService0205(): PHPStan\Type\Php\DateTimeModifyReturnTypeExtension
	{
		return new PHPStan\Type\Php\DateTimeModifyReturnTypeExtension('DateTimeImmutable');
	}


	public function createService0206(): PHPStan\Type\Php\DateTimeConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\DateTimeConstructorThrowTypeExtension;
	}


	public function createService0207(): PHPStan\Type\Php\DateTimeZoneConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\DateTimeZoneConstructorThrowTypeExtension;
	}


	public function createService0208(): PHPStan\Type\Php\DsMapDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\DsMapDynamicReturnTypeExtension;
	}


	public function createService0209(): PHPStan\Type\Php\DsMapDynamicMethodThrowTypeExtension
	{
		return new PHPStan\Type\Php\DsMapDynamicMethodThrowTypeExtension;
	}


	public function createService0210(): PHPStan\Type\Php\DioStatDynamicFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\DioStatDynamicFunctionReturnTypeExtension;
	}


	public function createService0211(): PHPStan\Type\Php\ExplodeFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ExplodeFunctionDynamicReturnTypeExtension($this->getService('020'));
	}


	public function createService0212(): PHPStan\Type\Php\FilterFunctionReturnTypeHelper
	{
		return new PHPStan\Type\Php\FilterFunctionReturnTypeHelper($this->getService('reflectionProvider'), $this->getService('020'));
	}


	public function createService0213(): PHPStan\Type\Php\FilterInputDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\FilterInputDynamicReturnTypeExtension($this->getService('0212'));
	}


	public function createService0214(): PHPStan\Type\Php\FilterVarDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\FilterVarDynamicReturnTypeExtension($this->getService('0212'));
	}


	public function createService0215(): PHPStan\Type\Php\FilterVarArrayDynamicReturnTypeExtension
	{
	...
	public function createService0216(): PHPStan\Type\Php\GetCalledClassDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\GetCalledClassDynamicReturnTypeExtension;
	}


	public function createService0217(): PHPStan\Type\Php\GetClassDynamicReturnTypeExtension
	{
	...
	public function createService0219(): PHPStan\Type\Php\GettypeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\GettypeFunctionReturnTypeExtension;
	}


	public function createService0220(): PHPStan\Type\Php\GettimeofdayDynamicFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\GettimeofdayDynamicFunctionReturnTypeExtension;
	}


	public function createService0221(): PHPStan\Type\Php\HashFunctionsReturnTypeExtension
	{
	...
	public function createService0224(): PHPStan\Type\Php\JsonThrowTypeExtension
	{
		return new PHPStan\Type\Php\JsonThrowTypeExtension($this->getService('reflectionProvider'), $this->getService('0152'));
	}
	...
	public function createService0227(): PHPStan\Type\Php\ReflectionMethodConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\ReflectionMethodConstructorThrowTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0228(): PHPStan\Type\Php\ReflectionPropertyConstructorThrowTypeExtension
	{
		return new PHPStan\Type\Php\ReflectionPropertyConstructorThrowTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0229(): PHPStan\Type\Php\StrContainingTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\StrContainingTypeSpecifyingExtension;
	}


	public function createService0230(): PHPStan\Type\Php\SimpleXMLElementClassPropertyReflectionExtension
	{
		return new PHPStan\Type\Php\SimpleXMLElementClassPropertyReflectionExtension;
	}


	public function createService0231(): PHPStan\Type\Php\SimpleXMLElementConstructorThrowTypeExtension
	{
	...
	public function createService0233(): PHPStan\Type\Php\MethodExistsTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\MethodExistsTypeSpecifyingExtension;
	}


	public function createService0234(): PHPStan\Type\Php\PropertyExistsTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\PropertyExistsTypeSpecifyingExtension($this->getService('0146'));
	}


	public function createService0235(): PHPStan\Type\Php\MinMaxFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\MinMaxFunctionReturnTypeExtension($this->getService('020'));
	}


	public function createService0236(): PHPStan\Type\Php\NumberFormatFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\NumberFormatFunctionDynamicReturnTypeExtension;
	}


	public function createService0237(): PHPStan\Type\Php\PathinfoFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\PathinfoFunctionDynamicReturnTypeExtension($this->getService('reflectionProvider'));
	}


	public function createService0238(): PHPStan\Type\Php\PregFilterFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\PregFilterFunctionReturnTypeExtension;
	}


	public function createService0239(): PHPStan\Type\Php\PregSplitDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\PregSplitDynamicReturnTypeExtension($this->getService('0152'));
	}


	public function createService0240(): PHPStan\Type\Php\ReflectionClassIsSubclassOfTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\ReflectionClassIsSubclassOfTypeSpecifyingExtension;
	}


	public function createService0241(): PHPStan\Type\Php\ReplaceFunctionsDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ReplaceFunctionsDynamicReturnTypeExtension;
	}


	public function createService0242(): PHPStan\Type\Php\ArrayPointerFunctionsDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\ArrayPointerFunctionsDynamicReturnTypeExtension;
	}


	public function createService0243(): PHPStan\Type\Php\LtrimFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\LtrimFunctionReturnTypeExtension;
	}


	public function createService0244(): PHPStan\Type\Php\MbFunctionsReturnTypeExtension
	{
		return new PHPStan\Type\Php\MbFunctionsReturnTypeExtension($this->getService('020'));
	}


	public function createService0245(): PHPStan\Type\Php\MbConvertEncodingFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\MbConvertEncodingFunctionReturnTypeExtension;
	}


	public function createService0246(): PHPStan\Type\Php\MbSubstituteCharacterDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\MbSubstituteCharacterDynamicReturnTypeExtension($this->getService('020'));
	}


	public function createService0247(): PHPStan\Type\Php\MbStrlenFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\MbStrlenFunctionReturnTypeExtension($this->getService('020'));
	}


	public function createService0248(): PHPStan\Type\Php\MicrotimeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\MicrotimeFunctionReturnTypeExtension;
	}


	public function createService0249(): PHPStan\Type\Php\HrtimeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\HrtimeFunctionReturnTypeExtension;
	}


	public function createService0250(): PHPStan\Type\Php\ImplodeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\ImplodeFunctionReturnTypeExtension;
	}


	public function createService0251(): PHPStan\Type\Php\NonEmptyStringFunctionsReturnTypeExtension
	{
		return new PHPStan\Type\Php\NonEmptyStringFunctionsReturnTypeExtension;
	}


	public function createService0252(): PHPStan\Type\Php\StrCaseFunctionsReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrCaseFunctionsReturnTypeExtension;
	}


	public function createService0253(): PHPStan\Type\Php\StrlenFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrlenFunctionReturnTypeExtension;
	}


	public function createService0254(): PHPStan\Type\Php\StrIncrementDecrementFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrIncrementDecrementFunctionReturnTypeExtension;
	}


	public function createService0255(): PHPStan\Type\Php\StrPadFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrPadFunctionReturnTypeExtension;
	}


	public function createService0256(): PHPStan\Type\Php\StrRepeatFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrRepeatFunctionReturnTypeExtension;
	}


	public function createService0257(): PHPStan\Type\Php\SubstrDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\SubstrDynamicReturnTypeExtension;
	}


	public function createService0258(): PHPStan\Type\Php\ThrowableReturnTypeExtension
	{
		return new PHPStan\Type\Php\ThrowableReturnTypeExtension;
	}


	public function createService0259(): PHPStan\Type\Php\ParseUrlFunctionDynamicReturnTypeExtension
	{
	...
	public function createService0261(): PHPStan\Type\Php\VersionCompareFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\VersionCompareFunctionDynamicReturnTypeExtension;
	}


	public function createService0262(): PHPStan\Type\Php\PowFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\PowFunctionReturnTypeExtension;
	}


	public function createService0263(): PHPStan\Type\Php\RoundFunctionReturnTypeExtension
	{
	...
	public function createService0265(): PHPStan\Type\Php\RandomIntFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\RandomIntFunctionReturnTypeExtension;
	}


	public function createService0266(): PHPStan\Type\Php\RangeFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\RangeFunctionReturnTypeExtension;
	}


	public function createService0267(): PHPStan\Type\Php\AssertFunctionTypeSpecifyingExtension
	{
	...
	public function createService0270(): PHPStan\Type\Php\DefineConstantTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\DefineConstantTypeSpecifyingExtension;
	}


	public function createService0271(): PHPStan\Type\Php\DefinedConstantTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\DefinedConstantTypeSpecifyingExtension($this->getService('0192'));
	}


	public function createService0272(): PHPStan\Type\Php\FunctionExistsFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\FunctionExistsFunctionTypeSpecifyingExtension;
	}


	public function createService0273(): PHPStan\Type\Php\InArrayFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\InArrayFunctionTypeSpecifyingExtension;
	}


	public function createService0274(): PHPStan\Type\Php\IsArrayFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsArrayFunctionTypeSpecifyingExtension(false);
	}


	public function createService0275(): PHPStan\Type\Php\IsCallableFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsCallableFunctionTypeSpecifyingExtension($this->getService('0233'));
	}


	public function createService0276(): PHPStan\Type\Php\IsIterableFunctionTypeSpecifyingExtension
	{
	...
	{
		return new PHPStan\Type\Php\IsSubclassOfFunctionTypeSpecifyingExtension($this->getService('0280'));
	}


	public function createService0278(): PHPStan\Type\Php\IteratorToArrayFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\IteratorToArrayFunctionReturnTypeExtension;
	}


	public function createService0279(): PHPStan\Type\Php\IsAFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\IsAFunctionTypeSpecifyingExtension($this->getService('0280'));
	}


	public function createService0280(): PHPStan\Type\Php\IsAFunctionTypeSpecifyingHelper
	{
		return new PHPStan\Type\Php\IsAFunctionTypeSpecifyingHelper;
	}


	public function createService0281(): PHPStan\Type\Php\CtypeDigitFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\Php\CtypeDigitFunctionTypeSpecifyingExtension;
	}


	public function createService0282(): PHPStan\Type\Php\JsonThrowOnErrorDynamicReturnTypeExtension
	{
	...
	public function createService0283(): PHPStan\Type\Php\TypeSpecifyingFunctionsDynamicReturnTypeExtension
	{
	...
	public function createService0285(): PHPStan\Type\Php\SimpleXMLElementXpathMethodReturnTypeExtension
	{
		return new PHPStan\Type\Php\SimpleXMLElementXpathMethodReturnTypeExtension;
	}


	public function createService0286(): PHPStan\Type\Php\StrSplitFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrSplitFunctionReturnTypeExtension($this->getService('020'));
	}


	public function createService0287(): PHPStan\Type\Php\StrTokFunctionReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrTokFunctionReturnTypeExtension;
	}


	public function createService0288(): PHPStan\Type\Php\SprintfFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\SprintfFunctionDynamicReturnTypeExtension;
	}


	public function createService0289(): PHPStan\Type\Php\SscanfFunctionDynamicReturnTypeExtension
	{
	...
	public function createService0291(): PHPStan\Type\Php\StrWordCountFunctionDynamicReturnTypeExtension
	{
		return new PHPStan\Type\Php\StrWordCountFunctionDynamicReturnTypeExtension;
	}


	public function createService0292(): PHPStan\Type\Php\XMLReaderOpenReturnTypeExtension
	{
	...
	public function createService0295(): PHPStan\Type\Php\ReflectionGetAttributesMethodReturnTypeExtension
	{
		return new PHPStan\Type\Php\ReflectionGetAttributesMethodReturnTypeExtension('ReflectionFunctionAbstract');
	}


	public function createService0296(): PHPStan\Type\Php\ReflectionGetAttributesMethodReturnTypeExtension
	{
		return new PHPStan\Type\Php\ReflectionGetAttributesMethodReturnTypeExtension('ReflectionParameter');
	}


	public function createService0297(): PHPStan\Type\Php\ReflectionGetAttributesMethodReturnTypeExtension
	{
	...
	public function createService0300(): PHPStan\Type\Constant\OversizedArrayBuilder
	{
		return new PHPStan\Type\Constant\OversizedArrayBuilder;
	}


	public function createService0301(): PHPStan\Reflection\BetterReflection\BetterReflectionSourceLocatorFactory
	{
	...
	public function createService0302(): PHPStan\Reflection\BetterReflection\BetterReflectionProviderFactory
	{
		return new class ($this) implements PHPStan\Reflection\BetterReflection\BetterReflectionProviderFactory {
			...
			public function create(PHPStan\BetterReflection\Reflector\Reflector $reflector): PHPStan\Reflection\BetterReflection\BetterReflectionProvider
			{
				return new PHPStan\Reflection\BetterReflection\BetterReflectionProvider(
					...
					$reflector,
					$this->container->getService('0149'),
					...
					$this->container->getService('0304'),
	...
	public function createService0303(): PHPStan\Reflection\BetterReflection\SourceStubber\PhpStormStubsSourceStubberFactory
	{
	...
	public function createService0304(): PHPStan\BetterReflection\SourceLocator\SourceStubber\PhpStormStubsSourceStubber
	{
		return $this->getService('0303')->create();
	}


	public function createService0305(): PHPStan\BetterReflection\SourceLocator\SourceStubber\ReflectionSourceStubber
	{
		return new PHPStan\BetterReflection\SourceLocator\SourceStubber\ReflectionSourceStubber($this->getService('018'));
	}


	public function createService0306(): PHPStan\Command\ErrorFormatter\CiDetectedErrorFormatter
	{
	...
	public function createService0314(): PHPStan\Rules\Classes\ExistingClassInInstanceOfRule
	{
	...
	public function createService0315(): PHPStan\Rules\Exceptions\CaughtExceptionExistenceRule
	{
	...
	public function createService0316(): PHPStan\Rules\Functions\CallToNonExistentFunctionRule
	{
		return new PHPStan\Rules\Functions\CallToNonExistentFunctionRule($this->getService('reflectionProvider'), false);
	}


	public function createService0317(): PHPStan\Rules\Constants\OverridingConstantRule
	{
		return new PHPStan\Rules\Constants\OverridingConstantRule(true);
	}


	public function createService0318(): PHPStan\Rules\Methods\OverridingMethodRule
	{
	...
	public function createService0319(): PHPStan\Rules\Methods\ConsistentConstructorRule
	{
		return new PHPStan\Rules\Methods\ConsistentConstructorRule($this->getService('0135'));
	}


	public function createService0320(): PHPStan\Rules\Missing\MissingReturnRule
	{
		return new PHPStan\Rules\Missing\MissingReturnRule(false, true);
	}


	public function createService0321(): PHPStan\Rules\Namespaces\ExistingNamesInGroupUseRule
	{
	...
	public function createService0322(): PHPStan\Rules\Namespaces\ExistingNamesInUseRule
	{
	...
	public function createService0323(): PHPStan\Rules\Operators\InvalidIncDecOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidIncDecOperationRule(false);
	}


	public function createService0324(): PHPStan\Rules\Properties\AccessPropertiesRule
	{
	...
	public function createService0325(): PHPStan\Rules\Properties\AccessStaticPropertiesRule
	{
	...
	public function createService0326(): PHPStan\Rules\Properties\ExistingClassesInPropertiesRule
	{
	...
	public function createService0327(): PHPStan\Rules\Functions\FunctionCallableRule
	{
	...
	public function createService0328(): PHPStan\Rules\Properties\MissingReadOnlyByPhpDocPropertyAssignRule
	{
		return new PHPStan\Rules\Properties\MissingReadOnlyByPhpDocPropertyAssignRule($this->getService('0337'));
	}


	public function createService0329(): PHPStan\Rules\Properties\OverridingPropertyRule
	{
		return new PHPStan\Rules\Properties\OverridingPropertyRule(true, false);
	}


	public function createService0330(): PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyRule;
	}


	public function createService0331(): PHPStan\Rules\Properties\UninitializedPropertyRule
	{
		return new PHPStan\Rules\Properties\UninitializedPropertyRule($this->getService('0337'));
	}


	public function createService0332(): PHPStan\Rules\Properties\WritingToReadOnlyPropertiesRule
	{
	...
	public function createService0333(): PHPStan\Rules\Properties\ReadingWriteOnlyPropertiesRule
	{
	...
	public function createService0334(): PHPStan\Rules\Variables\CompactVariablesRule
	{
		return new PHPStan\Rules\Variables\CompactVariablesRule(true);
	}


	public function createService0335(): PHPStan\Rules\Variables\DefinedVariableRule
	{
		return new PHPStan\Rules\Variables\DefinedVariableRule(true, true);
	}


	public function createService0336(): PHPStan\Rules\Regexp\RegularExpressionPatternRule
	{
		return new PHPStan\Rules\Regexp\RegularExpressionPatternRule;
	}


	public function createService0337(): PHPStan\Reflection\ConstructorsHelper
	{
		return new PHPStan\Reflection\ConstructorsHelper($this->getService('061'), []);
	}


	public function createService0338(): PHPStan\Rules\Methods\MissingMagicSerializationMethodsRule
	{
		return new PHPStan\Rules\Methods\MissingMagicSerializationMethodsRule($this->getService('020'));
	}


	public function createService0339(): PHPStan\Rules\Constants\MagicConstantContextRule
	{
		return new PHPStan\Rules\Constants\MagicConstantContextRule;
	}


	public function createService0340(): PHPStan\Rules\Classes\MixinRule
	{
	...
	public function createService0341(): PHPStan\Rules\PhpDoc\RequireExtendsCheck
	{
		return new PHPStan\Rules\PhpDoc\RequireExtendsCheck($this->getService('0112'), true);
	}


	public function createService0342(): PHPStan\Rules\PhpDoc\RequireImplementsDefinitionTraitRule
	{
	...
	public function createService0343(): PHPStan\Rules\Functions\IncompatibleArrowFunctionDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Functions\IncompatibleArrowFunctionDefaultParameterTypeRule;
	}


	public function createService0344(): PHPStan\Rules\Functions\IncompatibleClosureDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Functions\IncompatibleClosureDefaultParameterTypeRule;
	}


	public function createService0345(): PHPStan\Rules\Functions\CallCallablesRule
	{
		return new PHPStan\Rules\Functions\CallCallablesRule($this->getService('0123'), $this->getService('0147'), true);
	}


	public function createService0346(): PHPStan\Rules\Methods\IllegalConstructorMethodCallRule
	{
		return new PHPStan\Rules\Methods\IllegalConstructorMethodCallRule;
	}


	public function createService0347(): PHPStan\Rules\Methods\IllegalConstructorStaticCallRule
	{
		return new PHPStan\Rules\Methods\IllegalConstructorStaticCallRule;
	}


	public function createService0348(): PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule($this->getService('023'), $this->getService('026'), false, false);
	}


	public function createService0349(): PHPStan\Rules\PhpDoc\InvalidPhpDocVarTagTypeRule
	{
	...
	public function createService0350(): PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule($this->getService('023'), $this->getService('026'), false);
	}


	public function createService0351(): PHPStan\Rules\PhpDoc\VarTagChangedExpressionTypeRule
	{
		return new PHPStan\Rules\PhpDoc\VarTagChangedExpressionTypeRule($this->getService('0142'));
	}


	public function createService0352(): PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule
	{
		return new PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule($this->getService('0149'), $this->getService('0142'), false);
	}


	public function createService0353(): PHPStan\Rules\Generics\PropertyVarianceRule
	{
		return new PHPStan\Rules\Generics\PropertyVarianceRule($this->getService('0130'), false);
	}


	public function createService0354(): PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule($this->getService('0147'), true);
	}


	public function createService0355(): PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule(true);
	}


	public function createService0356(): PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule($this->getService('0147'), $this->getService('0111'), true);
	}


	public function createService0357(): PHPStan\Rules\Exceptions\ThrowsVoidFunctionWithExplicitThrowPointRule
	{
	...
	public function createService0358(): PHPStan\Rules\Exceptions\ThrowsVoidMethodWithExplicitThrowPointRule
	{
	...
	public function createService0359(): PHPStan\Rules\Generators\YieldFromTypeRule
	{
		return new PHPStan\Rules\Generators\YieldFromTypeRule($this->getService('0147'), true);
	}


	public function createService0360(): PHPStan\Rules\Generators\YieldInGeneratorRule
	{
		return new PHPStan\Rules\Generators\YieldInGeneratorRule(true);
	}


	public function createService0361(): PHPStan\Rules\Arrays\ArrayUnpackingRule
	{
		return new PHPStan\Rules\Arrays\ArrayUnpackingRule($this->getService('020'), $this->getService('0147'));
	}


	public function createService0362(): PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRefRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRefRule($this->getService('0146'));
	}


	public function createService0363(): PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRule($this->getService('0146'), $this->getService('0337'));
	}


	public function createService0364(): PHPStan\Rules\Classes\ImpossibleInstanceOfRule
	{
		return new PHPStan\Rules\Classes\ImpossibleInstanceOfRule(false, true, false);
	}


	public function createService0365(): PHPStan\Rules\Comparison\BooleanAndConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanAndConstantConditionRule($this->getService('0114'), true, false, false);
	}


	public function createService0366(): PHPStan\Rules\Comparison\BooleanOrConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanOrConstantConditionRule($this->getService('0114'), true, false, false);
	}


	public function createService0367(): PHPStan\Rules\Comparison\BooleanNotConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanNotConstantConditionRule($this->getService('0114'), true, false);
	}


	public function createService0368(): PHPStan\Rules\DeadCode\NoopRule
	{
		return new PHPStan\Rules\DeadCode\NoopRule($this->getService('017'), false);
	}


	public function createService0369(): PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule($this->getService('0144'), [], [], false);
	}


	public function createService0370(): PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule($this->getService('0114'), true);
	}


	public function createService0371(): PHPStan\Rules\Comparison\ElseIfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\ElseIfConstantConditionRule($this->getService('0114'), true, false);
	}


	public function createService0372(): PHPStan\Rules\Comparison\IfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\IfConstantConditionRule($this->getService('0114'), true);
	}


	public function createService0373(): PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule($this->getService('0115'), false, true, false);
	}


	public function createService0374(): PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule($this->getService('0115'), false, true, false);
	}


	public function createService0375(): PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule($this->getService('0115'), false, true, false);
	}


	public function createService0376(): PHPStan\Rules\Comparison\LogicalXorConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\LogicalXorConstantConditionRule($this->getService('0114'), true, false);
	}


	public function createService0377(): PHPStan\Rules\Comparison\MatchExpressionRule
	{
		return new PHPStan\Rules\Comparison\MatchExpressionRule($this->getService('0114'), false, false, false, true);
	}


	public function createService0378(): PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule(true);
	}


	public function createService0379(): PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule
	{
		return new PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule(false, true, false);
	}


	public function createService0380(): PHPStan\Rules\Comparison\ConstantLooseComparisonRule
	{
		return new PHPStan\Rules\Comparison\ConstantLooseComparisonRule(false, true, false);
	}


	public function createService0381(): PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule($this->getService('0114'), true);
	}


	public function createService0382(): PHPStan\Rules\Comparison\UnreachableIfBranchesRule
	{
		return new PHPStan\Rules\Comparison\UnreachableIfBranchesRule($this->getService('0114'), true, false);
	}


	public function createService0383(): PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule
	{
		return new PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule($this->getService('0114'), true, false);
	}


	public function createService0384(): PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule($this->getService('0114'), true);
	}


	public function createService0385(): PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule($this->getService('0114'), true);
	}


	public function createService0386(): PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule(false, false);
	}


	public function createService0387(): PHPStan\Rules\Properties\NullsafePropertyFetchRule
	{
		return new PHPStan\Rules\Properties\NullsafePropertyFetchRule;
	}


	public function createService0388(): PHPStan\Rules\Traits\TraitDeclarationCollector
	{
		return new PHPStan\Rules\Traits\TraitDeclarationCollector;
	}


	public function createService0389(): PHPStan\Rules\Traits\TraitUseCollector
	{
		return new PHPStan\Rules\Traits\TraitUseCollector;
	}


	public function createService0390(): PHPStan\Rules\Traits\NotAnalysedTraitRule
	{
		return new PHPStan\Rules\Traits\NotAnalysedTraitRule;
	}


	public function createService0391(): PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule
	{
		return new PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule($this->getService('exceptionTypeResolver'), true);
	}


	public function createService0392(): PHPStan\Rules\Functions\RandomIntParametersRule
	{
		return new PHPStan\Rules\Functions\RandomIntParametersRule($this->getService('reflectionProvider'), true);
	}


	public function createService0393(): PHPStan\Rules\Functions\ArrayFilterRule
	{
		return new PHPStan\Rules\Functions\ArrayFilterRule($this->getService('reflectionProvider'), true);
	}


	public function createService0394(): PHPStan\Rules\Functions\CallUserFuncRule
	{
		return new PHPStan\Rules\Functions\CallUserFuncRule($this->getService('reflectionProvider'), $this->getService('0123'));
	}


	public function createService0395(): Spaze\PHPStan\Rules\Disallowed\Allowed\Allowed
	{
		return new Spaze\PHPStan\Rules\Disallowed\Allowed\Allowed(
	...
	public function createService0396(): Spaze\PHPStan\Rules\Disallowed\Allowed\AllowedPath
	{
		return new Spaze\PHPStan\Rules\Disallowed\Allowed\AllowedPath($this->getService('0402'));
	}


	public function createService0397(): Spaze\PHPStan\Rules\Disallowed\DisallowedAttributeFactory
	{
		return new Spaze\PHPStan\Rules\Disallowed\DisallowedAttributeFactory($this->getService('0395'), $this->getService('0405'));
	}


	public function createService0398(): Spaze\PHPStan\Rules\Disallowed\DisallowedCallFactory
	{
		return new Spaze\PHPStan\Rules\Disallowed\DisallowedCallFactory(
			$this->getService('0403'),
			$this->getService('0405'),
	...
	public function createService0399(): Spaze\PHPStan\Rules\Disallowed\DisallowedConstantFactory
	{
		return new Spaze\PHPStan\Rules\Disallowed\DisallowedConstantFactory($this->getService('0405'));
	}


	public function createService0400(): Spaze\PHPStan\Rules\Disallowed\DisallowedNamespaceFactory
	{
		return new Spaze\PHPStan\Rules\Disallowed\DisallowedNamespaceFactory($this->getService('0405'));
	}


	public function createService0401(): Spaze\PHPStan\Rules\Disallowed\DisallowedSuperglobalFactory
	{
		return new Spaze\PHPStan\Rules\Disallowed\DisallowedSuperglobalFactory;
	}


	public function createService0402(): Spaze\PHPStan\Rules\Disallowed\File\FilePath
	{
		return new Spaze\PHPStan\Rules\Disallowed\File\FilePath($this->getService('069'), null);
	}


	public function createService0403(): Spaze\PHPStan\Rules\Disallowed\Formatter\Formatter
	{
		return new Spaze\PHPStan\Rules\Disallowed\Formatter\Formatter($this->getService('0405'));
	}


	public function createService0404(): Spaze\PHPStan\Rules\Disallowed\Identifier\Identifier
	{
		return new Spaze\PHPStan\Rules\Disallowed\Identifier\Identifier;
	}


	public function createService0405(): Spaze\PHPStan\Rules\Disallowed\Normalizer\Normalizer
	{
		return new Spaze\PHPStan\Rules\Disallowed\Normalizer\Normalizer;
	}


	public function createService0406(): Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedAttributeRuleErrors
	{
		return new Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedAttributeRuleErrors(
			$this->getService('0395'),
	...
	public function createService0407(): Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedConstantRuleErrors
	{
		return new Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedConstantRuleErrors(
			$this->getService('0396'),
			$this->getService('0403')
		);
	}
	...
	public function createService0408(): Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedMethodRuleErrors
	{
		return new Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedMethodRuleErrors(
	...
	public function createService0409(): Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedNamespaceRuleErrors
	{
		return new Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedNamespaceRuleErrors(
			$this->getService('0396'),
			$this->getService('0404'),
			$this->getService('0403')
		);
	...
	public function createService0410(): Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedCallsRuleErrors
	{
	...
	public function createService0411(): Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedVariableRuleErrors
	{
		return new Spaze\PHPStan\Rules\Disallowed\RuleErrors\DisallowedVariableRuleErrors(
			$this->getService('0396'),
			$this->getService('0403')
		);
	}
	...
	public function createService0412(): Spaze\PHPStan\Rules\Disallowed\Type\TypeResolver
	{
		return new Spaze\PHPStan\Rules\Disallowed\Type\TypeResolver;
	}


	public function createService0413(): Spaze\PHPStan\Rules\Disallowed\Usages\NamespaceUsages
	{
		return new Spaze\PHPStan\Rules\Disallowed\Usages\NamespaceUsages(
	...
	public function createService0414(): Spaze\PHPStan\Rules\Disallowed\Usages\NamespaceUsages
	{
		return new Spaze\PHPStan\Rules\Disallowed\Usages\NamespaceUsages(
			$this->getService('0409'),
			$this->getService('0400'),
	...
	public function createService0415(): Spaze\PHPStan\Rules\Disallowed\Calls\MethodCalls
	{
		return new Spaze\PHPStan\Rules\Disallowed\Calls\MethodCalls($this->getService('0408'), $this->getService('0398'), []);
	}


	public function createService0416(): Spaze\PHPStan\Rules\Disallowed\Calls\NewCalls
	{
		return new Spaze\PHPStan\Rules\Disallowed\Calls\NewCalls($this->getService('0410'), $this->getService('0398'), []);
	}


	public function createService0417(): Spaze\PHPStan\Rules\Disallowed\Calls\StaticCalls
	{
		return new Spaze\PHPStan\Rules\Disallowed\Calls\StaticCalls($this->getService('0408'), $this->getService('0398'), []);
	}


	public function createService0418(): Spaze\PHPStan\Rules\Disallowed\Calls\EvalCalls
	{
		return new Spaze\PHPStan\Rules\Disallowed\Calls\EvalCalls(
			$this->getService('0410'),
	...
	public function createService0419(): Spaze\PHPStan\Rules\Disallowed\Calls\EchoCalls
	{
		return new Spaze\PHPStan\Rules\Disallowed\Calls\EchoCalls(
			$this->getService('0410'),
			$this->getService('0398'),
			[
				['function' => 'exec()'],
	...
	public function createService0420(): Spaze\PHPStan\Rules\Disallowed\Calls\PrintCalls
	{
		return new Spaze\PHPStan\Rules\Disallowed\Calls\PrintCalls(
			$this->getService('0410'),
			$this->getService('0398'),
			[
				['function' => 'exec()'],
	...
	public function createService0421(): Spaze\PHPStan\Rules\Disallowed\Calls\EmptyCalls
	{
		return new Spaze\PHPStan\Rules\Disallowed\Calls\EmptyCalls(
			$this->getService('0410'),
			$this->getService('0398'),
			[
				['function' => 'exec()'],
	...
	public function createService0422(): Spaze\PHPStan\Rules\Disallowed\Calls\ExitDieCalls
	{
		return new Spaze\PHPStan\Rules\Disallowed\Calls\ExitDieCalls(
			$this->getService('0410'),
			$this->getService('0398'),
			[
				['function' => 'exec()'],
	...
	public function createService0423(): Spaze\PHPStan\Rules\Disallowed\Calls\FunctionCalls
	{
		return new Spaze\PHPStan\Rules\Disallowed\Calls\FunctionCalls(
			$this->getService('0410'),
			$this->getService('0398'),
			$this->getService('reflectionProvider'),
			[
	...
	public function createService0424(): Spaze\PHPStan\Rules\Disallowed\Calls\ShellExecCalls
	{
		return new Spaze\PHPStan\Rules\Disallowed\Calls\ShellExecCalls(
			$this->getService('0410'),
			$this->getService('0398'),
			[
				['function' => 'exec()'],
	...
	public function createService0425(): Spaze\PHPStan\Rules\Disallowed\Usages\ConstantUsages
	{
		return new Spaze\PHPStan\Rules\Disallowed\Usages\ConstantUsages($this->getService('0407'), $this->getService('0399'), []);
	}


	public function createService0426(): Spaze\PHPStan\Rules\Disallowed\Usages\ClassConstantUsages
	{
		return new Spaze\PHPStan\Rules\Disallowed\Usages\ClassConstantUsages(
	...
	public function createService0427(): Spaze\PHPStan\Rules\Disallowed\Usages\VariableUsages
	{
		return new Spaze\PHPStan\Rules\Disallowed\Usages\VariableUsages(
			$this->getService('0411'),
			$this->getService('0401')->getDisallowedVariables([])
		);
	}


	public function createService0428(): Spaze\PHPStan\Rules\Disallowed\Usages\AttributeUsages
	{
		return new Spaze\PHPStan\Rules\Disallowed\Usages\AttributeUsages($this->getService('0406'), $this->getService('0397'), []);
	}
	...
	{
		return $this->getService('0301')->create();
	}
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/ipp-php/tmp/cache/PHPStan');
	}


	public function createServiceClassConstantUsages(): Spaze\PHPStan\Rules\Disallowed\Usages\ClassConstantUsages
	{
		return new Spaze\PHPStan\Rules\Disallowed\Usages\ClassConstantUsages(
			$this->getService('0407'),
			$this->getService('0399'),
	...
	public function createServiceContainer(): Container_b402e2e175
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('/ipp-php');
	}
	...
	{
		return new PHPStan\Rules\Generics\EnumAncestorsRule($this->getService('0127'), $this->getService('0126'));
	}
	...
	{
		return new PHPStan\Rules\Generics\FunctionTemplateTypeRule($this->getService('0149'), $this->getService('0129'));
	}


	public function createServiceRules__103(): PHPStan\Rules\Generics\FunctionSignatureVarianceRule
	{
		return new PHPStan\Rules\Generics\FunctionSignatureVarianceRule($this->getService('0130'));
	}


	public function createServiceRules__104(): PHPStan\Rules\Generics\InterfaceAncestorsRule
	{
		return new PHPStan\Rules\Generics\InterfaceAncestorsRule($this->getService('0127'), $this->getService('0126'));
	}


	public function createServiceRules__105(): PHPStan\Rules\Generics\InterfaceTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\InterfaceTemplateTypeRule($this->getService('0129'));
	}


	public function createServiceRules__106(): PHPStan\Rules\Generics\MethodTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\MethodTemplateTypeRule($this->getService('0149'), $this->getService('0129'));
	}


	public function createServiceRules__107(): PHPStan\Rules\Generics\MethodSignatureVarianceRule
	{
		return new PHPStan\Rules\Generics\MethodSignatureVarianceRule($this->getService('0130'));
	}


	public function createServiceRules__108(): PHPStan\Rules\Generics\TraitTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\TraitTemplateTypeRule($this->getService('0149'), $this->getService('0129'));
	}


	public function createServiceRules__109(): PHPStan\Rules\Generics\UsedTraitsRule
	{
		return new PHPStan\Rules\Generics\UsedTraitsRule($this->getService('0149'), $this->getService('0127'));
	}
	...
	public function createServiceRules__110(): PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule
	{
		return new PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule;
	}


	public function createServiceRules__111(): PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule;
	}


	public function createServiceRules__112(): PHPStan\Rules\Operators\InvalidBinaryOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidBinaryOperationRule($this->getService('017'), $this->getService('0147'));
	}


	public function createServiceRules__113(): PHPStan\Rules\Operators\InvalidUnaryOperationRule
	{
	...
	{
		return new PHPStan\Rules\Operators\InvalidComparisonOperationRule($this->getService('0147'));
	}


	public function createServiceRules__115(): PHPStan\Rules\PhpDoc\FunctionConditionalReturnTypeRule
	{
		return new PHPStan\Rules\PhpDoc\FunctionConditionalReturnTypeRule($this->getService('0139'));
	}


	public function createServiceRules__116(): PHPStan\Rules\PhpDoc\MethodConditionalReturnTypeRule
	{
		return new PHPStan\Rules\PhpDoc\MethodConditionalReturnTypeRule($this->getService('0139'));
	}


	public function createServiceRules__117(): PHPStan\Rules\PhpDoc\FunctionAssertRule
	{
		return new PHPStan\Rules\PhpDoc\FunctionAssertRule($this->getService('0140'));
	}


	public function createServiceRules__118(): PHPStan\Rules\PhpDoc\MethodAssertRule
	{
		return new PHPStan\Rules\PhpDoc\MethodAssertRule($this->getService('0140'));
	}
	...
	{
		return new PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule($this->getService('0128'), $this->getService('0141'));
	}
	...
	{
		return new PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule($this->getService('0128'), $this->getService('0141'));
	}


	public function createServiceRules__123(): PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule($this->getService('0149'));
	}


	public function createServiceRules__124(): PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule
	{
		return new PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule;
	}


	public function createServiceRules__125(): PHPStan\Rules\Classes\RequireImplementsRule
	{
		return new PHPStan\Rules\Classes\RequireImplementsRule;
	}


	public function createServiceRules__126(): PHPStan\Rules\Classes\RequireExtendsRule
	{
		return new PHPStan\Rules\Classes\RequireExtendsRule;
	}


	public function createServiceRules__127(): PHPStan\Rules\PhpDoc\RequireImplementsDefinitionClassRule
	{
		return new PHPStan\Rules\PhpDoc\RequireImplementsDefinitionClassRule;
	}


	public function createServiceRules__128(): PHPStan\Rules\PhpDoc\RequireExtendsDefinitionClassRule
	{
		return new PHPStan\Rules\PhpDoc\RequireExtendsDefinitionClassRule($this->getService('0341'));
	}


	public function createServiceRules__129(): PHPStan\Rules\PhpDoc\RequireExtendsDefinitionTraitRule
	{
	...
	public function createServiceRules__130(): PHPStan\Rules\Arrays\ArrayDestructuringRule
	{
		return new PHPStan\Rules\Arrays\ArrayDestructuringRule($this->getService('0147'), $this->getService('0111'));
	}


	public function createServiceRules__131(): PHPStan\Rules\Arrays\IterableInForeachRule
	{
		return new PHPStan\Rules\Arrays\IterableInForeachRule($this->getService('0147'));
	}


	public function createServiceRules__132(): PHPStan\Rules\Arrays\OffsetAccessAssignmentRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessAssignmentRule($this->getService('0147'));
	}


	public function createServiceRules__133(): PHPStan\Rules\Arrays\OffsetAccessAssignOpRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessAssignOpRule($this->getService('0147'));
	}


	public function createServiceRules__134(): PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule($this->getService('0147'));
	}


	public function createServiceRules__135(): PHPStan\Rules\Arrays\UnpackIterableInArrayRule
	{
		return new PHPStan\Rules\Arrays\UnpackIterableInArrayRule($this->getService('0147'));
	}


	public function createServiceRules__136(): PHPStan\Rules\Exceptions\ThrowExprTypeRule
	{
		return new PHPStan\Rules\Exceptions\ThrowExprTypeRule($this->getService('0147'));
	}


	public function createServiceRules__137(): PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule($this->getService('0125'));
	}


	public function createServiceRules__138(): PHPStan\Rules\Functions\ClosureReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ClosureReturnTypeRule($this->getService('0125'));
	}


	public function createServiceRules__139(): PHPStan\Rules\Functions\ReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ReturnTypeRule($this->getService('0125'));
	}
	...
	public function createServiceRules__140(): PHPStan\Rules\Generators\YieldTypeRule
	{
		return new PHPStan\Rules\Generators\YieldTypeRule($this->getService('0147'));
	}


	public function createServiceRules__141(): PHPStan\Rules\Methods\ReturnTypeRule
	{
		return new PHPStan\Rules\Methods\ReturnTypeRule($this->getService('0125'));
	}


	public function createServiceRules__142(): PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule
	{
		return new PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule($this->getService('0147'));
	}


	public function createServiceRules__143(): PHPStan\Rules\Properties\ReadOnlyPropertyAssignRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyPropertyAssignRule($this->getService('0146'), $this->getService('0337'));
	}


	public function createServiceRules__144(): PHPStan\Rules\Properties\ReadOnlyPropertyAssignRefRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyPropertyAssignRefRule($this->getService('0146'));
	}


	public function createServiceRules__145(): PHPStan\Rules\Properties\TypesAssignedToPropertiesRule
	{
		return new PHPStan\Rules\Properties\TypesAssignedToPropertiesRule($this->getService('0147'), $this->getService('0146'));
	}


	public function createServiceRules__146(): PHPStan\Rules\Variables\ThrowTypeRule
	{
		return new PHPStan\Rules\Variables\ThrowTypeRule($this->getService('0147'));
	}


	public function createServiceRules__147(): PHPStan\Rules\Variables\VariableCloningRule
	{
		return new PHPStan\Rules\Variables\VariableCloningRule($this->getService('0147'));
	}


	public function createServiceRules__148(): PHPStan\Rules\Arrays\DeadForeachRule
	{
		return new PHPStan\Rules\Arrays\DeadForeachRule;
	}


	public function createServiceRules__149(): PHPStan\Rules\DeadCode\UnreachableStatementRule
	{
	...
	public function createServiceRules__150(): PHPStan\Rules\DeadCode\UnusedPrivateConstantRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivateConstantRule($this->getService('0138'));
	}


	public function createServiceRules__151(): PHPStan\Rules\DeadCode\UnusedPrivateMethodRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivateMethodRule;
	}


	public function createServiceRules__152(): PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule
	{
		return new PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule;
	}


	public function createServiceRules__153(): PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__154(): PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule
	{
	...
	{
		return new PHPStan\Rules\Methods\CallToMethodStatementWithoutSideEffectsRule($this->getService('0147'));
	}
	...
	public function createServiceRules__162(): PHPStan\Rules\Functions\ImplodeFunctionRule
	{
		return new PHPStan\Rules\Functions\ImplodeFunctionRule($this->getService('reflectionProvider'), $this->getService('0147'));
	}


	public function createServiceRules__163(): PHPStan\Rules\Constants\MissingClassConstantTypehintRule
	{
		return new PHPStan\Rules\Constants\MissingClassConstantTypehintRule($this->getService('0136'));
	}


	public function createServiceRules__164(): PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule($this->getService('0136'));
	}


	public function createServiceRules__165(): PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule($this->getService('0136'));
	}


	public function createServiceRules__166(): PHPStan\Rules\Methods\MissingMethodParameterTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodParameterTypehintRule($this->getService('0136'));
	}


	public function createServiceRules__167(): PHPStan\Rules\Methods\MissingMethodReturnTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodReturnTypehintRule($this->getService('0136'));
	}


	public function createServiceRules__168(): PHPStan\Rules\Properties\MissingPropertyTypehintRule
	{
		return new PHPStan\Rules\Properties\MissingPropertyTypehintRule($this->getService('0136'));
	}
	...
	{
		return new PHPStan\Rules\Classes\LocalTypeAliasesRule($this->getService('0113'));
	}


	public function createServiceRules__29(): PHPStan\Rules\Classes\LocalTypeTraitAliasesRule
	{
		return new PHPStan\Rules\Classes\LocalTypeTraitAliasesRule($this->getService('0113'), $this->getService('reflectionProvider'));
	}
	...
	{
		return new PHPStan\Rules\Constants\DynamicClassConstantFetchRule($this->getService('020'), $this->getService('0147'));
	}
	...
	{
		return new PHPStan\Rules\Functions\ArrowFunctionReturnNullsafeByRefRule($this->getService('0137'));
	}
	...
	{
		return new PHPStan\Rules\Functions\ExistingClassesInClosureTypehintsRule($this->getService('0124'));
	}


	public function createServiceRules__47(): PHPStan\Rules\Functions\ExistingClassesInTypehintsRule
	{
		return new PHPStan\Rules\Functions\ExistingClassesInTypehintsRule($this->getService('0124'));
	}
	...
	{
		return new PHPStan\Rules\Functions\ReturnNullsafeByRefRule($this->getService('0137'));
	}
	...
	{
		return new PHPStan\Rules\Methods\CallMethodsRule($this->getService('0132'), $this->getService('0123'));
	}


	public function createServiceRules__61(): PHPStan\Rules\Methods\CallStaticMethodsRule
	{
		return new PHPStan\Rules\Methods\CallStaticMethodsRule($this->getService('0133'), $this->getService('0123'));
	}
	...
	{
		return new PHPStan\Rules\Methods\ExistingClassesInTypehintsRule($this->getService('0124'));
	}
	...
	{
		return new PHPStan\Rules\Methods\MethodCallableRule($this->getService('0132'), $this->getService('020'));
	}
	...
	{
		return new PHPStan\Rules\Methods\StaticMethodCallableRule($this->getService('0133'), $this->getService('020'));
	}
	...
	{
		return new PHPStan\Rules\Operators\InvalidAssignVarRule($this->getService('0137'));
	}


	public function createServiceRules__72(): PHPStan\Rules\Properties\AccessPropertiesInAssignRule
	{
		return new PHPStan\Rules\Properties\AccessPropertiesInAssignRule($this->getService('0324'));
	}


	public function createServiceRules__73(): PHPStan\Rules\Properties\AccessStaticPropertiesInAssignRule
	{
		return new PHPStan\Rules\Properties\AccessStaticPropertiesInAssignRule($this->getService('0325'));
	}
	...
	{
		return new PHPStan\Rules\Properties\MissingReadOnlyPropertyAssignRule($this->getService('0337'));
	}
	...
	{
		return new PHPStan\Rules\Classes\UnusedConstructorParametersRule($this->getService('0148'));
	}
	...
	{
		return new PHPStan\Rules\Functions\UnusedClosureUsesRule($this->getService('0148'));
	}


	public function createServiceRules__87(): PHPStan\Rules\Variables\EmptyRule
	{
		return new PHPStan\Rules\Variables\EmptyRule($this->getService('0131'));
	}


	public function createServiceRules__88(): PHPStan\Rules\Variables\IssetRule
	{
		return new PHPStan\Rules\Variables\IssetRule($this->getService('0131'));
	}


	public function createServiceRules__89(): PHPStan\Rules\Variables\NullCoalesceRule
	{
		return new PHPStan\Rules\Variables\NullCoalesceRule($this->getService('0131'));
	}
	...
	{
		return new PHPStan\Rules\Cast\EchoRule($this->getService('0147'));
	}


	public function createServiceRules__91(): PHPStan\Rules\Cast\InvalidCastRule
	{
		return new PHPStan\Rules\Cast\InvalidCastRule($this->getService('reflectionProvider'), $this->getService('0147'));
	}


	public function createServiceRules__92(): PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule
	{
		return new PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule($this->getService('017'), $this->getService('0147'));
	}


	public function createServiceRules__93(): PHPStan\Rules\Cast\PrintRule
	{
		return new PHPStan\Rules\Cast\PrintRule($this->getService('0147'));
	}
	...
	{
		return new PHPStan\Rules\Generics\ClassAncestorsRule($this->getService('0127'), $this->getService('0126'));
	}


	public function createServiceRules__99(): PHPStan\Rules\Generics\ClassTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\ClassTemplateTypeRule($this->getService('0129'));
	}


	public function createServiceSimpleRelativePathHelper(): PHPStan\File\RelativePathHelper
	{
		return new PHPStan\File\SimpleRelativePathHelper('/ipp-php');
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludePaths' => null,
			'level' => 9,
			'paths' => ['/ipp-php/core', '/ipp-php/student'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'memoryLimitFile' => '/ipp-php/tmp/.memory_limit',
			'tempResultCachePath' => '/ipp-php/tmp/resultCaches',
			'resultCachePath' => '/ipp-php/tmp/resultCache.php',
			...
			'tempDir' => '/ipp-php/tmp',
			'rootDir' => '/ipp-php/vendor/phpstan/phpstan',
			'currentWorkingDirectory' => '/ipp-php',
			'cliArgumentsVariablesRegistered' => true,
			'additionalConfigFiles' => [
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon',
				'/ipp-php/phpstan.neon',
			],
			'allConfigFiles' => [
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/parametersSchema.neon',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level7.neon',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level4.neon',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level3.neon',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level2.neon',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level1.neon',
				'phar:///ipp-php/vendor/phpstan/phpstan/phpstan.phar/conf/config.level0.neon',
				'/ipp-php/phpstan.neon',
				'/ipp-php/vendor/spaze/phpstan-disallowed-calls/extension.neon',
			],
			'composerAutoloaderProjectPaths' => ['/ipp-php/vendor/phpstan/phpstan/..', '/ipp-php'],
