...
trait preProcess
{
        ...
        foreach ($args as $arg) {
            if (preg_match('/arg(\d+)/', $arg->nodeName, $matches)) {
                ...
                if ($arg instanceof DOMElement) {
                    ...
                    // Handle the case where $arg is not a DOMElement
                ...
                if ($argument->type == "string") {
                    ...
                    if ($escapedValue !== null) {
                        ...
                        // Handle the case where the escape method returns null
                        // For example, throw an exception or use a default value
    ...
    private function progCheck(): void
    {
        ...
        if ($this->program !== null) { // Check if $this->program is not null
            ...
            // Handle case where no program elements are found
            //TODO: exception code
